          ...
          <div className="md:w-1/2 flex justify-evenly flex-col px-3 gap-3 py-3 lg:text-lg">
            ...
            <div className="flex flex-col gap-3 text-justify">
              ...
              <div>
                ...
                içeriklerle üretilen ürünlerimiz, vücudunuzu dengede tutarak
                doğal bir yaşam sürmenize yardımcı olacaktır.
              </div>
              <div>
                Müşteri memnuniyeti bizim için en önemli önceliktir. Sizlere en
                iyi hizmeti sunabilmek adına, uzman ekibimiz her zaman
